    ...
    <div class="cart-card">
        ...
        <div style="height:50%; border-left:grey 3px solid;margin:40px;border-right:grey 3px solid;margin:40px">
            <div style="height: 100%;justify-content:center;flex-direction:column;align-self:center;">
                <p style="flex-direction: column;display: flex;justify-content: center;align-self: center;height: 100%;text-align: center;">Aucun Pari séléctionné</p>
            </div>
        </div>
        <div style="width:50%;text-align: center; background-color:#FBCD27; padding:10px 15px;margin-left:20%">Parier</div>
    </div>
</div>